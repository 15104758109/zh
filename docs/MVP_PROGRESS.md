...
- L1A `dd559013-19eb-4cd0-ad2d-fb6ff0f2ce92` 已经由真实生产页生成并批准第 7、8 章候选；ZH04 执行 `4122` 返回两个候选章节版本，数据库状态为 `candidate`、`is_formal=false`，等待既有 deduction/audit/作者确认链路。
...
从既有 deduction 页面加载第 7、8 章候选，按同一页面、n8n、PostgreSQL 与刷新恢复链路完成正文推演、审计和作者确认，再继续第 9、10 章。
