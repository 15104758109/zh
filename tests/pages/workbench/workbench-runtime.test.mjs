...
test("workbench saves a controlled model template only after D-046 evidence", () => {
  ...
  assert.doesNotMatch(testConnectionSource, /modalApiKeyInput|api_key_ref|api_key/);
  ...
  assert.doesNotMatch(templateSaveRequest[0], /provider_base_url|model_name|api_key_ref|api_key/);
