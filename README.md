...
| [当前 G07-A v3 机械证据](./docs/G07_A_EVIDENCE_V3.json) | 锁定 v3 实现 commit、G06 原版/现版自测、G07 自测、Dry Run 三快照、治理 scope 与秘密扫描哈希 |
...
| `G07_GATE` / `G07_A_STATUS` | `PENDING` / `IMPLEMENTED`；第二轮 P0/P1 已完成 v3 返修并登记新证据，等待新的独立 G07-B 与创作者裁决，不得执行产品 Task |
